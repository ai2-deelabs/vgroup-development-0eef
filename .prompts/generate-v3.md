...
modular editorial grid, magazine-style with pull-quotes and numbered service blocks breaking a strict 12-col structure — condensed display sans headlines paired with a classic serif for body copy — 60% chalk white #F4F6F2, 30% mid jade #2E7D5B, 10% surprise cobalt-teal jewel accent #0057A3 for key stats/icons — mood inspired by Swiss International Style transit signage, confident and systematized.
