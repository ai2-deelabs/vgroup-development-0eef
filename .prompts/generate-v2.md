...
dark full-viewport hero with a thin animated pipeline/schematic line drawing, content in centered narrow column, generous negative space — geometric grotesk (Neue Haas/Aktiv-style) tight tracking, all-caps micro-labels — near-black graphite canvas #0A0D0C + one electric acid-green accent #B6FF3C used only for CTAs and live data pulses — mood of a monitoring-room HUD at night, precise and quietly high-stakes.
